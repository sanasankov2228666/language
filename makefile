...
INCLUDES = -I./include -I./common -I./source/common

COMMON_SRC = $(wildcard common/*.cpp) $(wildcard source/common/*.cpp)
AST_SRC = $(wildcard source/ast/*.cpp)

OTHER_SRC = $(COMMON_SRC) $(AST_SRC)
